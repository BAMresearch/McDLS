...
def HDFCleanup(infile):
    ...
    tempfname = "{}.hdf5".format(str(uuid.uuid4().hex)) # generate a temporary file for the original backup
    tempofname = "{}.hdf5".format(str(uuid.uuid4().hex)) # temporary output filename
